...
public class JServerPanel extends JModePanel<BootModel> implements ActionListener,
    ...
    private final JComboBox<Integer> intervalComboBox;
    private final JDirectoryChooser directoryChooser;

    public JServerPanel(BootListener listener) {
        ...
        add(IntervalLabel, "2, 6, right, default");
        intervalComboBox = getIntervalSelect();
        add(intervalComboBox, "4, 6, 7, 1, fill, default");
        //===================Path====================================
        ...
        add(selectBtn, "4, 8, 7, 1");
        //===================start====================================
        startBtn = new JButton("start");
        startBtn.addActionListener(this);
        add(startBtn, "4, 10, 7, 1");
    ...
    private JComboBox<Integer> getIntervalSelect() {
        JComboBox<Integer> jComboBox = new JComboBox<>();
        for (int i = 1; i <= 20; i++) {
            jComboBox.addItem(i * 500);
        }
        return jComboBox;
    }
